    ...
    <el-drawer
      ...
      <el-container class="shop-cart-wrap">
        ...
        <el-main style="padding: 0px">
          ...
          <el-row class="shop-good" v-for="(item, index) in goods" :key="index">
            ...
            <el-col :span="3"> <button class="del-good" @click="delGoods" ><i class="el-icon-delete"></i></button> </el-col>
          </el-row>
        </el-main>
        <el-footer class="shop-cart-footer">
          <el-row id="wrap-footer">
            ...
            <el-col :span="7">已选中10件商品</el-col>
            <el-col :span="4">共￥100元</el-col>
            <el-col :span="5">
