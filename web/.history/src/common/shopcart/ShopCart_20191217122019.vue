    ...
    <el-drawer
      ...
      <el-container class="shop-cart-wrap">
        ...
        <el-main style="padding: 0px">
          ...
          <el-row class="shop-good" v-for="(item, index) in 10" :key="index">
            <el-col :span="2"> <el-checkbox  label=""></el-checkbox>
            </el-col>
            <el-col :span="9">商品名称</el-col>
            <el-col :span="5">
            ...
            <el-col :span="3"><el-button type="info" icon="el-icon-message" circle></el-button> </el-button></el-col>
          </el-row>
        </el-main>
        <el-footer>
