      ...
      <el-col :span="14"  :offset="5">
        <div id="nav-bar-links">
          ...
          <el-link id="right-part" :underline="false">
            <el-link v-if="logined" :underline="false" class="right-links" >
              <i class="el-icon-user"></i>
            </el-link>
            <el-link v-if="!logined" :underline="false" class="right-links" >注册</el-link>
            <!-- <el-divider direction="vertical"></el-divider> -->
            <el-link v-if="!logined"  :underline="false" class="right-links" >登录</el-link>
          </el-link >
        </div>
      </el-col>
    </el-row>
