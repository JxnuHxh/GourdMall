    ...
    <el-row :gutter="20">
      <el-col :span="14"  :offset="5">
        <div id="nav-bar-links"  >
          <el-link :underline="false" :disabled = "index === '0'" @mouseenter="naventer({'cid' ,})" @click="change('0')"><div > 首页</div></el-link>
          <span v-for="item in cateGories" v-bind:key="item.cid">
            <el-link :underline="false" :disabled = "index === item.cid" @click="change(item.cid)"><div @mouseenter="naventer(item.cid)">{{item.cname}}</div></el-link>
          </span>
