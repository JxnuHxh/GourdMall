      ...
      <el-row id="float-bar" v-show="true" >
        <el-col :span="2" :offset="5">
          <el-card :body-style="{ padding: '0px' }" shadow="never">
            <img src="https://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png" height="140px" width="100px" class="image">
              <div style="padding: 0px;">
                <!-- <span style="margin: 0px">好吃的汉堡</span> -->
                <div class="bottom clearfix" style="padding: 0px; height: 20px; margin-top: -30px;">
