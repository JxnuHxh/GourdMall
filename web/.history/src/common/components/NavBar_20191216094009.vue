<template>
  <div id="nav-container" @mouseleave="navleave()">
    ...
    <fade-animation :fadeIn="fadein" :fadeOut="fadeon">
      <el-row id="float-bar" v-show="true" >
        <el-col :span="2" :offset="5">
          <el-card :body-style="{ padding: '0px' }" shadow="never">
            <img src="https://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png" height="120px" width="100px" class="image">
              <div style="padding: 0px;">
                <!-- <span style="margin: 0px">好吃的汉堡</span> -->
                <div class="bottom clearfix" style="padding: 0px; height: 20px; margin-top: -40px;">
                  <time class="time">111111</time>
