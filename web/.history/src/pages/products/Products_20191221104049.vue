<template>
  <div >
    <div id="fixed-header" v-if="false">
...
import ProductsWrap from './components/Container'
...
export default {
  ...
  created () {
    // console.log('商品列表页的参数')
    console.log(this.$route.query)

    this.flashProductList({cid: this.$route.query.cid, pageNum: 1, pageSize: 10})
  },
  mounted () {
