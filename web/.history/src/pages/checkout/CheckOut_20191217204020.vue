          ...
          <el-col :span="14" :offset="5">
              ...
              <el-container id="products-wrap">
                ...
                <el-main id="products">
                  ...
                  <el-row class="container"  @click="product()" v-for="(item, index) in goods" v-bind:key="index">
                    <el-col :span="14" >.
                      <div class="info">
                        <el-row>
                          <el-col :span="5">
                          ...
                          <el-col :span="19">
                            <p >
                              订单服务 服务支持 媒体中心 关注我们订单服务 服务支持 媒体中心 关注我们订单服务 服务支持 媒体中心 关注我们
                            </p>
                          </el-col>
                        </el-row>
                      </div>
                    ...
                    <el-col :span="4">
                      <span style="font-weight: blod; color: red">￥1000元</span>
                    </el-col>
                  </el-row>
                  <el-row class="footer">
                    <el-col :span="12" offset="12">
                      总共￥<span>100000</span>元
