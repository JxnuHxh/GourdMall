<template>
  <div>
    ...
    <el-button @click="flashCateList('222222222')">异步刷新分类列表</el-button>
    <el-button @click="flashProductList()">异步刷新商品列表</el-button>
    <el-button @click="getUserMsg()">异步刷新用户信息</el-button>
    <el-button @click="resetUserState()">重置用户信息</el-button>
    <el-button @click="deleteCategory({
      cid: '4'
    })">删除分类测试</el-button>
    <el-button @click="flashCategory()">更新分类测试</el-button>
