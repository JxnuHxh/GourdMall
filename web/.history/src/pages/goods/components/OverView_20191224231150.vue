<template>
  <el-row class='over-view-wrap'>
    <el-col :span="4" id="left">
      <el-row style="height: 80px; width: 80px" class="mini-pic"   v-for="(item,index) in getProduct.overView" :key="index">
    ...
    <el-col :span="8" id="center">
      <el-row>
        <el-col :span="24" class="big-pic-wrap">
          ...
          <magnify-glass class="big-pic"  :previewImg="getProduct.overView[this.show]" :zoomImg="getProduct.overView[this.show]"></magnify-glass>
        </el-col>
      </el-row>
    </el-col>
        ...
        <el-col :span="24">
          ...
          <div class="info-middle">
            ...
            <div id="list-demo" class="num-change">
              ...
              <h1>
              <span style="color: red; top: -50px; left: 180px; position: relative;">￥{{getProduct.marketPrice}}</span>
            </h1>
            </div>
          </div>
