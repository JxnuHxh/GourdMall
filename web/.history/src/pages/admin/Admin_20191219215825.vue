  ...
  <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
    ...
    <el-menu >
      ...
      <el-submenu index="3">
        ...
        <el-menu-item index="3-1" @click="addTab('3-1', '订单列表', 'OrderManage')" >销量统计</el-menu-item>
      </el-submenu>
      <el-submenu index="3">
        <template slot="title" ><i class="el-icon-s-marketing"></i>系统设置</template>
        <el-menu-item index="3-1" @click="addTab('3-1', '订单列表', 'OrderManage')" >基本设置（不开发）</el-menu-item>
      </el-submenu>
    </el-menu>
  </el-aside>
