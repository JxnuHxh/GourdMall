              ...
              <el-col :span="12" :offset="6">
                <el-form
                  ...
                  <el-form-item prop="adminNo">
                    <el-select v-model="accountForm.adminNo" style="margin-top: 70px" v size="medium" placeholder="请选择管理员账号">
                      <el-option
                        v-for="item in options"
                        v-model="accountForm.adminNo"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value">
                      </el-option>
    ...
    accountLogin: function (formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          let data = {
            studentNo: this.accountForm.studentNo,
