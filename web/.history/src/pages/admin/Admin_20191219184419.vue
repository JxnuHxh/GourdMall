...
<el-container style="height: 940px; border: 1px solid #eee">
  ...
  <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
    ...
    <el-menu >
      <el-avatar  @click="addTab('打开商品列表')" :size="100" :src="LogoUrl" style="margin-left: 40px;margin-top: 20px"> </el-avatar>
      <el-submenu index="1">
        <template slot="title" >
        ...
        <el-menu-item-group>
          ...
          <el-submenu index="1-2">
            ...
            <el-menu-item index="1-2-1" @click="addTab('打开商品列表')">商品列表</el-menu-item>
          </el-submenu>
        </el-menu-item-group>
      </el-submenu>
      <el-submenu index="2">
