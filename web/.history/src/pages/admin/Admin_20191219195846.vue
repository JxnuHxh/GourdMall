  ...
  <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
    ...
    <el-menu >
      ...
      <el-submenu index="1">
        ...
        <el-menu-item-group>
          <el-submenu index="1-1">
            ...
            <el-menu-item index="1-1-1" @click="addTab('1-1-1', '查看分类列表', 'ProductManage')">分类列表</el-menu-item>
      ...
      <el-submenu index="2">
        ...
        <el-menu-item index="2-1" @click="addTab('2-1', '角色列表', 'ProductManage')" >角色列表</el-menu-item>
      ...
      <el-submenu index="3">
        ...
        <el-menu-item index="3-1" @click="addTab('3-1', '订单列表', 'ProductManage')" >订单列表</el-menu-item>
      </el-submenu>
    </el-menu>
  </el-aside>
  ...
  methods: {
    ...
    removeTab (targetIndex) {
      ...
      if (targetIndex === 'dash' || this.openTabs.length === 0) {
        ...
        let list = this.openTabs.filter(item => {
          if (item.name === targetIndex) { return true }
        })
        console.log(list)
      }
