<template>
  ...
  center>
        <el-form :model="form" :rules="rules" ref="form">
          ...
          <el-form-item label="商品pid" prop="cid" :label-width="formLabelWidth">
          ...
          <el-form-item label="商品进价" prop="cname" :label-width="formLabelWidth">
            <el-input v-model="form.shopPrice" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="商品售价" prop="cname" :label-width="formLabelWidth">
            <el-input v-model="form.shopPrice" autocomplete="off"></el-input>
          </el-form-item>
        </el-form>
