...
<el-container style="height: 940px; border: 1px solid #eee">
  ...
  <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
    ...
    <el-menu :default-openeds="['1', '3']" >
      <el-avatar :size="100" :src="LogoUrl" style="margin-left: 40px;margin-top: 100px"> </el-avatar>
      <el-submenu index="1">
        <template slot="title" >
        ...
        <el-menu-item-group>
          ...
          <el-menu-item index="1-1" @click="addTab(editableTabsValue)">分类管理</el-menu-item>
