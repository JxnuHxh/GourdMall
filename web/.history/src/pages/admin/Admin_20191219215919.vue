...
<el-container style="height: 940px; border: 1px solid #eee">
  ...
  <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
    ...
    <el-menu >
      ...
      <el-submenu index="5">
        <template slot="title" ><i class="el-icon-s-marketing"></i>系统设置</template>
        <el-menu-item index="5-1" @click="addTab('3-1', '基本设置', 'OrderManage')" >基本设置（不开发）</el-menu-item>
        <el-menu-item index="5-1" @click="addTab('3-1', '系统日志', 'OrderManage')" >系统日志（不开发）</el-menu-item>
      </el-submenu>
    </el-menu>
  </el-aside>
