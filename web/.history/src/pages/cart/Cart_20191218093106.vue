            ...
            <el-container class="cart-wrap" v-if="products.total !== 0">
              ...
              <el-footer class="cart-footer">
                <el-row id="wrap-footer">
                  ...
                  <el-col :span="7">
                    <span>
                      <span>已选中 <span style="color: red; font-size: 18px">{{this.products.total}}</span> 件</span> / <span>共 <span style="color: red; font-size: 18px"> {{this.products.goods.length}}件</span></span>
                    </span>
                  </el-col>
