              ...
              <el-main style="padding: 0px">
                ...
                <div id="wrap-container">
                  <el-row class="good" v-for="(item, index) in products.goods" v-bind:key="index">
                    <el-col :span="8" style="line-height: 60px; height: 60px">
                      <el-avatar shape="square" :size="60"  :src="item.imgUrl"></el-avatar>  <div style="line-height: 60px; height: 60px"> <span >{{item.name}}</span></div>
                    </el-col>
