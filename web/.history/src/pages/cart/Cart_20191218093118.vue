            ...
            <el-container class="cart-wrap" v-if="products.total !== 0">
                  ...
                  <el-row class="good" v-for="(item, index) in products.goods"  v-bind:key="index">
                    <el-col :span="8" style="line-height: 130px; height: 130px">
                      <el-row style="padding: 0px">
                        ...
                        <el-col :span="13">
                          <p >{{item.name}}ssssssssssssssssssssssssssss</p>
                        </el-col>
                      </el-row>
                    </el-col>
              ...
              <el-footer class="cart-footer">
                <el-row id="wrap-footer">
                  ...
                  <el-col :span="7">
                    <span>
                      <span>已选中 <span style="color: red; font-size: 18px">{{this.products.total}}</span> 件</span> / <span>共 <span style="color: red; font-size: 18px"> {{this.products.goods.length}}</span>件</span>
                    </span>
                  </el-col>
                  <el-col :span="4">共￥{{this.products.sum}}元</el-col>
                  <el-col :span="5">
