        ...
        <el-row>
          <el-col :span="14" :offset="5">
            ...
            <el-container class="cart-wrap" v-if="products.goods.length !== 0">
              <el-header >
                购物清单 <span style="float: right; margin-right: 10px "><el-button type="danger" @click="confirm" icon="el-icon-delete" size="mini" circle></el-button></span>
              </el-header>
              ...
              <el-footer class="cart-footer">
                <el-row id="wrap-footer">
                  ...
                  <el-col :span="5">
                      <el-button type="primary" @click="Orger">立即下单</el-button>
                  </el-col>
                </el-row>
              </el-footer>
            </el-container>
