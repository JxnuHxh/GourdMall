    ...
    <el-col :span="14" :offset="5">
      ...
      <el-container id="phone-list" class="gods-list" style="overflow: auto;">
        ...
        <el-main>
          ...
          <el-row>
            <el-col :span="12">
              <el-card shadow="hover" style="height: 170px !important" :body-style="{ padding: '0px', height: '160px' }" class="big-img">
                <el-image :src="urls[0]"  fit="fill" style="height: 160px">
                  <div slot="error" class="image-slot">
                    <i class="el-icon-picture-outline" @click="Login()"></i>
                  </div>
                </el-image>
            ...
            <el-col :span="6" v-for="(item, index) in hotSale" :key="index">
              <el-card shadow="hover" :body-style="{ padding: '0px'  }" >
                <!-- {{item}} -->
                  ...
                  <el-image @click="Login()"
                    ...
                    <div style="padding: 5px;">
                      ...
                      <el-link class="price" :underline="false" v-if="card !== index">
                        ...
                        <el-button-group v-if="card === index">
