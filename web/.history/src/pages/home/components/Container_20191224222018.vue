    ...
    <el-col :span="14" :offset="5">
      ...
      <el-container id="hot-sale" class="gods-list">
        ...
        <el-main>
          <!-- Main content -->
          <el-row>
            <el-col v-for="(item, index) in hotSale.slice(0, 4)" :key="index" :span="6">
      ...
      <el-container id="phone-list" class="gods-list" style="overflow: auto;">
        ...
        <el-main>
          ...
          <el-row>
            <el-col :span="12">
              <el-card shadow="hover" :body-style="{ padding: '0px', height: '200px' }" class="big-img">
            ...
            <el-col :span="6" v-for="(item, index) in getProductList.data.slice(0, 6)" :key="index">
              <el-card shadow="hover" :body-style="{ padding: '0px'  }" >
                <!-- {{item}} -->
                <div @mouseenter="cardenter(index)" @mouseleave="cardleave()">
                  <el-image @click="Login()"
                    ...
                    <div style="padding: 5px;">
                      <span>{{item.pname}}</span>
                      <div></div>
                      <el-link class="price" :underline="false" v-if="card !== index">
                        <span >￥{{item.price}}</span>
                      </el-link>
                        <el-button-group v-if="card === index" style="margin-top: 7px">
