  ...
  <el-row :gutter="5">
    <el-col :span="5">
      <el-card :body-style="{ padding: '2px 0px 2px 5px', height: '400px' }" >
        <div @mouseenter="inBreadCrumb()" @mouseleave="outBreadCrumb()">
    ...
    <el-col :span="15">
      <div class="block">
        ...
        <fade-animation :fadeIn="fadeIn">
          <div id="menu" v-show="menuShow">
          <el-card :body-style="{height: '400px', padding: '0px'}">
          <el-container>
...
export default {
  ...
  data () {
    return {
      fadeIn: 'animated slideInLeft',
      fadeOut: 'animated slideOutLeft',
      menuShow: false,
      urls: [
