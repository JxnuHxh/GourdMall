      ...
      <el-container id="phone-list" class="gods-list" style="overflow: auto;">
        ...
        <el-main>
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-card shadow="hover" :body-style="{ padding: '0px' }" >
                <div @mouseenter="cardenter()" @mouseleave="cardleave()">
                  <el-image @click="Login()"
                    ...
                    <div style="padding: 5px;">
                      <span>好吃的汉堡2222</span>
                      <div></div>
                      <el-link class="price" :underline="false" v-show="!card">
                        <span >￥2,899.00</span>
                      </el-link>
                        <el-button-group v-show="card">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-card shadow="hover" :body-style="{ padding: '0px' }" >
                <div @click="Login()">
                    <el-avatar
                    style="width: 200px; height: 200px;margin-top: 35px;"
                    shape="square"
                    src="https://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png"
                    ></el-avatar>
                    <div style="padding: 14px;">
