 ...
 * @returns {Promise<AxiosResponse>}
 */
export function deleteData (urlLink, param) {
  const data = Object.assign({}, commonParams, param)
  return instance.delete(urlLink, qs.stringify(data))
    .then((res) => {
      return Promise.resolve(res.data)
    })
    .catch(function (error) {
      console.info('deleteDataError', error)
      return Promise.resolve(error)
    })
}
...
export function putData (urlLink, param) {
  const data = Object.assign({}, commonParams, param)
  return instance.put(urlLink, qs.stringify(data))
    .then((res) => {
      return Promise.resolve(res.data)
    })
    .catch(function (error) {
