    ...
    <el-row :gutter="20">
      <el-col :offset="5" :xs="24" :sm="24" :md="24" :lg="14" :xl="14"  id="nav-bar">
        ...
        <el-popover
          ...
          <el-link slot="reference" :underline="false" class="right-links"> 购物车</el-link>
        </el-popover>
        <el-link v-if="show" :underline="false" class="right-links"> 订单中心</el-link>
        <!-- 用户下拉菜单， 只在登录后才显示-->
        <el-dropdown v-if="show" class="right-links">
...
import logo from '../../../common/images/index-logo.png'
